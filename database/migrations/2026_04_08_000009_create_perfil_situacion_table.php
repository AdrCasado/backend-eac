...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('perfil_situacion', function (Blueprint $table) {
            $table->foreignId('perfil_habilitacion_id')->constrained('perfiles_habilitacion')->cascadeOnDelete();
            $table->foreignId('situacion_competencia_id')->constrained('situaciones_competencia')->cascadeOnDelete();
