...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sc_precedencia', function (Blueprint $table) {
            ...
            $table->foreignId('sc_id')->constrained('situaciones_competencia')->cascadeOnDelete();
            // La SC que debe estar conquistada previamente
            $table->foreignId('sc_requisito_id')->constrained('situaciones_competencia')->cascadeOnDelete();
